...
from .models.linknet import Linknet_bottleneck_crop as _Linknet_bottleneck_crop
...
Linknet_bottleneck_crop = inject_global_submodules(_Linknet_bottleneck_crop)
...
__all__ = [
    'Unet', 'PSPNet', 'FPN', 'Linknet', 'Linknet_bottleneck_crop',
